...
type Capability_Service_ struct {
	...
	Service *Capability_Service `protobuf:"bytes,1,opt,name=service,proto3,oneof"` //ReclaimSpace reclaim_space = 2;
}
...
var file_identity_identity_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x79, 0x12, 0x4c, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69,
...
var file_identity_identity_proto_depIdxs = []int32{
	...
	1,  // 5: identity.Identidy.GetIdentity:input_type -> identity.GetIdentityRequest
	3,  // 6: identity.Identidy.GetCapabilities:input_type -> identity.GetCapabilitiesRequest
	6,  // 7: identity.Identidy.Probe:input_type -> identity.ProbeRequest
	2,  // 8: identity.Identidy.GetIdentity:output_type -> identity.GetIdentityResponse
	4,  // 9: identity.Identidy.GetCapabilities:output_type -> identity.GetCapabilitiesResponse
	7,  // 10: identity.Identidy.Probe:output_type -> identity.ProbeResponse
